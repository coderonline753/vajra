...
The batteries-included TypeScript backend framework built on Bun. 29 modules, one peer dependency (Zod), production-tested.

[![npm version](https://img.shields.io/npm/v/vajrajs.svg)](https://www.npmjs.com/package/vajrajs)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
[![Tests](https://img.shields.io/badge/tests-547%20passing-brightgreen)](https://vajra.run)
[![Beta](https://img.shields.io/badge/status-beta-orange)](https://vajra.run)

> **v0.7.5 Beta** — 29 modules, 547 tests, 0 failures. Production-tested on [vajra.run](https://vajra.run).
...
Vajra uses **RSD** (Route, Service, Data), not MVC. Three layers, clear responsibilities.
...
MVC was built for desktop GUIs in 1979. RSD is built for APIs in 2026.
...
| **Vajra minimal** (Bun) | **105,000** | 29 modules loaded |
| Express (Node 24) | 95,000 | Routing only |
| **Vajra + batteries** (Bun) | **78,000** | Helmet + CORS + Rate Limit |

Vajra ships 29 modules built-in. Others ship routing only. Add security headers, CORS, rate limiting, JWT, and validation to any framework and the gap closes.
